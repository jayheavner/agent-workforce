...
derived from the slug, never passed to you, at `<project>/.claude/worktrees/<slug>` with the ref
`refs/heads/change/<slug>`. Write every artifact under that worktree — the `plans/`, `docs/`,
